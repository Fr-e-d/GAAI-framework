...
dispatch_3phase_story() {
  ...
  case "$ps" in
    ...
    qa_failed)
      ...
      ;;
    *)
      echo "[ERROR] ${story_id} dispatch_3phase_story: invalid phase_status='${ps}' — known values: not_started planned implemented qa_passed qa_failed qa_escalated done failed escalated worktree_recovery_failed[intermediate]"
