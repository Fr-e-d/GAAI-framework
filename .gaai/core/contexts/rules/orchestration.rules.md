...
Sub-agents spawned by the daemon (Planning, Implementation, QA, Specialists) each run in their own isolated context with a targeted context bundle. The 3-phase delivery model is implemented in `scripts/daemon-dispatch.sh`.
