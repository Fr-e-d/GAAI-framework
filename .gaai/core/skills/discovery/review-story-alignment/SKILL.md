...
**Do NOT activate:**
- For stories created outside a conversation (e.g., daemon-generated, bug-triage)
- When no Discovery Session Brief exists (no conversation context to check against)
- For stories that are already `refined` or `done`
