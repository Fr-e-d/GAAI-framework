---
name: create-skill
description: Guide creation of a new GAAI skill following the agentskills.io spec and GAAI best practices. Activate when adding a new skill to the .gaai/skills/ catalog.
license: MIT
...
outputs:
  - .gaai/skills/{category}/{skill-name}/SKILL.md
  - updated .gaai/skills/README.skills.md entry
---
...
- `.gaai/agents/discovery.agent.md` — Skills Used section
- `.gaai/agents/delivery.agent.md` — Skills Used section
