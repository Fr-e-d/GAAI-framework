...
# Extracts cost data from .gaai/.delivery-logs/*.log JSONL files
# Requires: jq >= 1.6
#
# Usage:
...
#   --logs-dir   Override delivery logs directory (default: .gaai/.delivery-logs)

set -euo pipefail

# ── Defaults ──────────────────────────────────────────────────────────────────
LOGS_DIR="${LOGS_DIR:-.gaai/.delivery-logs}"
OUTPUT_FORMAT="table"
